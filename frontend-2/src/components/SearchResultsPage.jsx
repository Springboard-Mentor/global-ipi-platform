                        ...
                        <div className="relative flex items-center bg-white rounded-[1.8rem] shadow-xl shadow-indigo-500/10 ring-1 ring-slate-900/5 transition-all">
                            ...
                            <div className="pr-2">
                                <button 
                                    ...
                                    className="h-12 px-8 bg-indigo-600 hover:bg-indigo-700 text-white rounded-[1.4rem] font-bold text-xs uppercase tracking-wider transition-all shadow-lg shadow-indigo-500/30 flex items-center gap-2 active:scale-95"
                                >
                                    ...
                                    <FilterGroup label="Asset Type">
                                        <div className="space-y-1">
                                            {['both', 'patent', 'trademark'].map(type => (
                                                <label key={type} className="flex items-center gap-3 p-2 rounded-lg cursor-pointer transition-colors hover:bg-slate-50">
                    ...
                    <main className="flex-1 min-w-0">
                        {loading ? (
                            ...
                            <div className="h-96 flex flex-col items-center justify-center bg-white rounded-3xl border border-dashed border-slate-200 text-center px-4">
                                ...
                                <p className="text-sm text-slate-500 max-w-xs mx-auto">Try adjusting your filters or search for a different keyword to locate assets.</p>
                            </div>
                        ) : (
                            <>
